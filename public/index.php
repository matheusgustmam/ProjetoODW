...
$dispatcher = FastRoute\simpleDispatcher(function (FastRoute\RouteCollector $r) {
    ...
    $r->post('/clientes/salvar', 'ClienteController@salvar');
    $r->post('/clientes/{id}/salvar', 'ClienteController@salvar');
    $r->post('/clientes/{id}/deletar', 'ClienteController@deletar');
    $r->get('/clientes/{clienteId}/contatos/{contatoId}', 'ClienteController@buscarContato');
    $r->post('/clientes/{clienteId}/contatos/salvar', 'ClienteController@salvarContato');
    $r->post('/clientes/{clienteId}/contatos/{contatoId}/salvar', 'ClienteController@salvarContato');
    $r->post('/clientes/{clienteId}/contatos/{contatoId}/deletar', 'ClienteController@deletarContato');
});
